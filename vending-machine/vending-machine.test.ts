...
test('cost of $1 and payment of $2 returns no change and 4 Quarters', () => {
  expect(vendingMachine(100, 200)).toBe(`
  Quarters: 4
  TotalChange: $0`)
})
...
test('cost of $2 and payment of $1 returns message of insufficient funds', () => {
  expect(vendingMachine(200, 100)).toBe(
    `Insufficient funds for desired product. We have returned your $2`,
  )
})
